...
Imputation based on Sector and Market cap Clustering
...
if __name__ == "__main__":
    ...
    df_original_train.set_index('Ticker',inplace=True)
    df_original_train.to_csv(args.train_output, index=True)
    ...
    df_new_test.set_index('Ticker',inplace=True)
    df_new_test.to_csv(args.test_output, index=True)
